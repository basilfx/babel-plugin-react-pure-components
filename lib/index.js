      ...
      Class: function Class(path, options) {
        ...
        if (options.opts.assignDefaultProps) {
          ...
          if (defaultProps) {
            ...
            functionalComponent.body.body.unshift(t.assignmentExpression('=', t.identifier(renameProps ? '__props' : 'props'), t.callExpression(t.memberExpression(t.identifier('Object'), t.identifier('assign')), [t.objectExpression([]), defaultProps.node.value, t.identifier(renameProps ? '__props' : 'props')])));
          }
        }
